<h2><a href="https://practice.geeksforgeeks.org/problems/factorial5739/1?page=2&difficulty[]=-1&status[]=unsolved&sortBy=submissions">Factorial</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a positive integer,&nbsp;<strong>N</strong>. Find the factorial of <strong>N</strong>.</span><br>
&nbsp;</p>
